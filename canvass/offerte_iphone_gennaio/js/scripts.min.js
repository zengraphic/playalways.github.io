...
function(window) {
    ...
    "function" == typeof define && define.amd ? define(classie) : "object" == typeof exports ? module.exports = classie : window.classie = classie
}(window),
"document"in self && !("classList"in document.createElement("_")) && !function(j) {
    "use strict";
    if ("Element"in j) {
        var a = "classList"
          , f = "prototype"
          ...
          , c = Array[f].indexOf || function(q) {
            for (var p = 0, o = this.length; o > p; p++)
          ...
          , d = function(s) {
            for (var r = k.call(s.getAttribute("class") || ""), q = r ? r.split(/\s+/) : [], p = 0, o = q.length; o > p; p++)
                this.push(q[p]);
        ...
        ,
        e.add = function() {
            var q, s = arguments, r = 0, p = s.length, o = !1;
            do
                q = s[r] + "",
                -1 === g(this, q) && (this.push(q),
                o = !0);
            while (++r < p);o && this._updateClassName()
        }
        ,
        e.remove = function() {
            var r, t = arguments, s = 0, p = t.length, o = !1;
            do {
                r = t[s] + "";
                var q = g(this, r);
                -1 !== q && (this.splice(q, 1),
                o = !0)
            } while (++s < p);o && this._updateClassName()
        }
        ,
        e.toggle = function(p, q) {
            p += "";
            var o = this.contains(p)
              , r = o ? q !== !0 && "remove" : q !== !1 && "add";
            return r && this[r](p),
            !o
        }
        ,
        ...
        b.defineProperty) {
            ...
            try {
                ...
                -2146823252 === h.number && (l.enumerable = !1,
                b.defineProperty(m, a, l))
            }
        } else
            b[f].__defineGetter__ && m.__defineGetter__(a, i)
    }
}(self),
...
function() {
        ...
        timeoutID = setTimeout(function() {
            for (var i = 0, il = queries.length; il > i; i++) {
                ...
                if (matches !== mql.matches) {
                    mql.matches = matches;
                    for (var j = 0, jl = listeners.length; jl > j; j++)
    ...
    window.matchMedia = function(media) {
        ...
        return mql.addListener = function(listener) {
            hasMediaQueries && (isListening || (isListening = !0,
            window.addEventListener("resize", handleChange, !0)),
            0 === index && (index = queries.push({
                mql: mql,
                listeners: listeners
            })),
        ...
        mql.removeListener = function(listener) {
            for (var i = 0, il = listeners.length; il > i; i++)
                listeners[i] === listener && listeners.splice(i, 1)
        }
        ,
        mql
    }
...
!function(e) {
    ...
    var t = function() {
        ...
        return e.style.cssText = "font-size: 1rem;",
        /rem/.test(e.style.fontSize)
    }
      , n = function() {
      ...
      , o = function(e, t) {
        if (p.push(e.responseText),
        v.push(t),
        v.length === h.length) {
            for (var n = 0; n < v.length; n++)
                a(p[n], v[n]);
            (h = m.slice(0)).length > 0 ? (v = [],
            p = [],
            m = [],
            r()) : i()
        }
      ...
      , a = function(e, t) {
        for (var n, r = d(e).replace(/\/\*[\s\S]*?\*\//g, ""), o = /[\w\d\s\-\/\\\[\]:,.'"*()<>+~%#^$_=|@]+\{[\w\d\s\-\/\\%#:!;,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!;,.'"*()]*\}/g, a = r.match(o), i = /\d*\.?\d+rem/g, s = r.match(i), c = /(.*\/)/, l = c.exec(t)[0], u = /@import (?:url\()?['"]?([^'\)"]*)['"]?\)?[^;]*/gm; null !== (n = u.exec(e)); )
            m.push(0 === n[1].indexOf("/") ? n[1] : l + n[1]);
        null !== a && 0 !== a.length && (f = f.concat(a),
        g = g.concat(s))
    }
      , i = function() {
        for (var e = /[\w\d\s\-\/\\%#:,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!,.'"*()]*[;}]/g, t = 0; t < f.length; t++) {
            u += f[t].substr(0, f[t].indexOf("{") + 1);
            for (var n = f[t].match(e), r = 0; r < n.length; r++)
                u += n[r],
                r === n.length - 1 && "}" !== u[u.length - 1] && (u += "\n}")
        }
        s()
    }
      , s = function() {
        for (var e = 0; e < g.length; e++)
            y[e] = Math.round(parseFloat(g[e].substr(0, g[e].length - 3) * w)) + "px";
        c()
    }
      , c = function() {
        for (var e = 0; e < y.length; e++)
            y[e] && (u = u.replace(g[e], y[e]));
        var t = document.createElement("style");
        t.setAttribute("type", "text/css"),
        t.id = "remReplace",
        document.getElementsByTagName("head")[0].appendChild(t),
        t.styleSheet ? t.styleSheet.cssText = u : t.appendChild(document.createTextNode(u))
    }
      , l = function(t, n) {
        try {
      ...
      , d = function(t) {
        return e.matchMedia || e.msMatchMedia || (t = t.replace(/@media[\s\S]*?\}\s*\}/g, "")),
        t
    };
    if (!t()) {
        var u = ""
          ...
          , w = "";
        w = function() {
            var e, t = document, n = t.documentElement, r = t.body || t.createElement("body"), o = !t.body, a = t.createElement("div"), i = r.style.fontSize;
            return o && n.appendChild(r),
            a.style.cssText = "width:1em; position:absolute; visibility:hidden; padding: 0;",
            r.style.fontSize = "1em",
            r.appendChild(a),
            e = a.offsetWidth,
            o ? n.removeChild(r) : (r.removeChild(a),
            r.style.fontSize = i),
            e
        }(),
        r()
...
var RimgOptions = {
    breakpoint: "_sm 360w 1x, _md 719w 1x, _lg 720w 1x",
    ...
    var e = function() {
        function e(e) {
            ...
            if (1 === t)
                return this.src[0];
            if (2 === t)
                return 1 >= e ? this.src[0] : this.src[1];
            for (var i = 0, n = this.pixelRatio.length; n > i; ) {
                if (e === this.pixelRatio[i] || Math.round(e) === this.pixelRatio[i])
                    return this.src[i];
                i++
            }
            return this.src[t - 1]
        ...
        function t(t) {
            if ("string" == typeof t) {
                ...
                if (0 === i.length)
                    return g.status = "error",
                    null;
                for (var n = [], o = 0, r = i.length; r > o; ) {
                    for (var a = i[o], s = {
                        src: [],
                        width: -1,
                        pixelRatio: [],
                        getSrc: e
                    }, d = a.split(" "), c = 0, u = d.length; u > c; ) {
                        var l = d[c];
                        "" === l.replace(" ", "") || (null !== l.match(/^[0-9]{0,4}w/gi) ? s.width = Number(l.substr(0, l.length - 1)) : null !== l.match(/[0-9]{1}x$/gi) ? s.pixelRatio.push(Number(l.substr(0, l.length - 1))) : s.src.push(l)),
                        c++
                    }
                    for (var f = 0, b = n.length, h = !1; b > f; ) {
                        var m = n[f];
                        if (m.width === s.width && -1 !== m.width) {
                            m.pixelRatio.push(s.pixelRatio[0]),
                            m.src.push(s.src[0]),
                            h = !0;
                            break
                        }
                ...
                return n.length > 0 ? n : (g.status = "error",
                null)
            }
            return g.status = "error",
            null
        ...
        function i(e, t, i) {
            var n, o = "";
            o = "img" === t ? "data-src" : "data-background-image",
            n = i.getAttribute(o),
            null === n ? e.ignore = !0 : (void 0 !== e.path && e.path !== n || void 0 === e.path) && (e.path = n,
            "data-background-image" === o ? e.background = !0 : e.background = !1,
            e.extension = d(n)),
            "gif" === e.extension || "svg" === e.extension ? e.ignore = !0 : void 0 === e.ignore && (e.ignore = !1)
        }
        function n(e) {
            for (var t = 0, i = g.images.length, n = !1; i > t; ) {
                if (g.images[t].target === e) {
                    n = !0;
                    break
                }
                t++
            }
            return n ? g.images[t] : null
        }
        function o(e) {
            for (var t, o, a, s = document.querySelectorAll("img"), d = 0, c = s.length; c > d; )
                t = s[d],
                a = n(t),
                null === a ? (o = {
                    target: t,
                    enabled: !g.disableIntrospection
                },
                i(o, "img", t),
                g.images.push(o),
                a = o) : (g.disableIntrospection && (a.enabled = !g.disableIntrospection),
                i(a, "img", t)),
                e && a.target === e && g.disableIntrospection && (a.enabled = !0),
                d++;
            for (s = document.querySelectorAll("[data-background-image]"),
            d = 0,
            c = s.length; c > d; )
                t = s[d],
                a = n(t),
                ...
                i(o, "background", t),
                g.images.push(o),
                a = o) : i(a, "background", t),
                e && a.target === e && g.disableIntrospection && (a.enabled = !0),
                d++;
            r()
        }
        function r() {
            for (var e, t = 0, i = g.images.length, n = window.devicePixelRatio || 1; i > t; ) {
                var o = g.images[t];
                if (!o.ignore && o.enabled) {
                    if (e = !0,
                    !g.disableLazyLoading) {
                        var r = o.target.getBoundingClientRect();
                        e = !(r.top + r.height < -g.offset.y || r.top > -g.offset.y + g.resizeDimensions.height + g.offset.y || r.left + r.width < -g.offset.x || r.left > -g.offset.x + g.resizeDimensions.width + g.offset.x)
                    }
                    var d;
                    if (d = o.background ? o.target.getAttribute("data-background-image") : o.target.getAttribute("data-src"),
                    null !== d && "" !== d && e) {
                        var c, u = d.substr(0, d.lastIndexOf(".")), l = o.extension, f = {
                            x: o.target.width
                        };
                        (0 === o.target.width || void 0 === o.target.width) && (c = o.background ? "width" : "maxWidth",
                        f.x = window.getComputedStyle(o.target, null)[c],
                        f.x = f.x.replace("px", ""),
                        f.x = Number(f.x));
                        for (var b = 0, h = g.breakpoints.length, m = void 0; h > b; ) {
                            var p = g.breakpoints[b]
                              , v = f.x;
                            if (v > p.width)
                                m = p;
                            else {
                        ...
                        if (void 0 === m && (m = g.breakpoints[0]),
                        m) {
                            var w = !1
                              , y = u + m.getSrc(n) + "." + l;
                            o.background || o.target.getAttribute("src") === y ? o.background && -1 === o.target.style.backgroundImage.indexOf(y) && (o.target.style.backgroundImage = "url(" + y + ")",
                            w = !0) : (o.target.setAttribute("src", y),
                            w = !0),
                            w && (g.imageEvents.changed++,
                            s("add", "load", a, o.target),
                            s("add", "error", a, o.target))
                        }
                    }
                } else if (o.ignore && ("svg" === o.extension || "gif" === o.extension))
                    if (o.background) {
                        var k = o.target.getAttribute("style");
                        if (k) {
                            var x = k.indexOf("background-image");
                            if (-1 === k.indexOf(o.path)) {
                                if (k && -1 === x)
                                    k = "background-image: url(" + o.path + ");" + k;
                                else if (k && -1 !== x) {
                                    var z = k.substr(x)
                                      , R = z.indexOf(";");
                                    void 0 === R && (R = z.length),
                                    k = k.substr(0, x) + "background-image: url(" + o.path + ");" + k.substr(R + 1)
                                }
                                o.target.setAttribute("style", k)
                            }
                        } else
                            k = "background-image: url(" + o.path + ");",
                            o.target.setAttribute("style", k)
                    } else
                        o.target.getAttribute("src") !== o.path && o.target.setAttribute("src", o.path);
                t++
            }
        }
        function a(e) {
            g.imageEvents.changed--,
            "error" === e.type && g.imageEvents.errors++,
            0 === g.imageEvents.changed && g.imagesLoaded && g.imagesLoaded(g.imageEvents.errors > 0 ? !0 : !1),
            e.path && e.path.length > 0 && (s("remove", "load", a, e.path[0]),
            s("remove", "error", a, e.path[0]))
        }
        function s(e, t, i, n) {
            void 0 === n && (n = document),
            "resize" === t && (n = window),
            g.isIE8 ? ("DOMContentLoaded" === t && (t = "onreadystatechange"),
            "resize" === t && (t = "onresize"),
            "add" === e ? n.attachEvent(t, i) : n.detachEvent(t, i)) : "add" === e ? n.addEventListener(t, i, !1) : n.removeEventListener(t, i, !1)
        }
        function d(e) {
        ...
        function c() {
            var e, t;
            g.isIE8 ? (e = document.body.clientWidth,
            t = document.body.clientHeight) : (e = window.innerWidth,
            t = window.innerHeight);
            var i = !1;
            return (g.resizeDimensions.width !== e || g.resizeDimensions.height !== t) && (g.resizeDimensions.width = e,
            g.resizeDimensions.height = t,
            i = !0),
            i
        }
        function u() {
            clearTimeout(g.resizeInfo.wait),
            c() && r(),
            g.resizeInfo.time = (new Date).getTime()
        }
        function l(e) {
        ...
        var g = {
            ...
            disableIntrospection: !1,
            disableLazyLoading: !1,
            isIE8: !1
        };
        if (void 0 === window.addEventListener && (g.isIE8 = !0),
        "undefined" != typeof window.RimgOptions) {
            var f = t(window.RimgOptions.breakpoint);
            null !== f && (g.breakpoints = f),
            window.RimgOptions.disableIntrospection === !0 && (g.disableIntrospection = !0),
            window.RimgOptions.disableLazyLoading === !0 && (g.disableLazyLoading = !0),
            null != window.RimgOptions.offset && "number" == typeof window.RimgOptions.offset.x && "number" == typeof window.RimgOptions.offset.y && (g.offset.x = window.RimgOptions.offset.x,
            g.offset.y = window.RimgOptions.offset.y),
            null !== window.RimgOptions.complete && "function" == typeof window.RimgOptions.complete && (g.imagesLoaded = window.RimgOptions.complete),
            window.RimgOptions = void 0
        }
        return {
            version: "2.1.0",
            execute: function(e) {
                return "error" === g.status ? void 0 : void 0 === e ? void 0 : 0 === g.breakpoints.length ? void 0 : void o(e)
            },
            configure: function(e) {
                if (!(e instanceof Object))
                    return void 0;
                if (e.breakpoint) {
                    var i = t(e.breakpoint);
                    null !== i && (g.breakpoints = i)
                }
                e.disableIntrospection === !0 && (g.disableIntrospection = !0),
                e.disableLazyLoading === !0 && (g.disableLazyLoading = !0),
                void 0 !== e.offset && "number" == typeof e.offset.x && "number" == typeof e.offset.y && (g.offset.x = e.offset.x,
                g.offset.y = e.offset.y),
                "ready" !== g.status || g.disableIntrospection || (c(),
                this.execute(document))
            },
            resized: function(e) {
                "ready" === g.status && (null !== g.resizeInfo.wait && clearTimeout(g.resizeInfo.wait),
                null === g.resizeInfo.time || (new Date).getTime() - g.resizeInfo.time > 1e3 ? u.bind(this)() : g.resizeInfo.wait = setTimeout(u.bind(this), 100))
            },
            scrolled: function(e) {
                g.disableLazyLoading || r()
            },
            loaded: function(e) {
                "progress" === g.status && (g.isIE8 && "complete" != document.readyState || (s("remove", "DOMContentLoaded", this.loaded),
                c(),
                g.disableIntrospection || (null !== g.observer && g.observer.observe(document.body, {
                    attributes: !0,
                    childList: !0,
                    characterData: !1,
                    subtree: !0,
                ...
                this.execute(document),
                s("add", "resize", this.resized.bind(this))),
                g.disableLazyLoading || s("add", "scroll", this.scrolled.bind(this)),
                g.status = "ready"))
            },
            disableLazyLoading: function() {
                g.disableLazyLoading = !0
            },
            disableIntrospection: function() {
                g.disableIntrospection = !0,
                g.observer ? g.observer.disconnect() : s("remove", "DOMNodeInserted", l)
            },
            initialize: function() {
                if ("init" !== g.status)
                    return void ("error" !== g.status && void 0);
                var e = this
                  , t = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver;
                void 0 === t || g.isIE8 ? (s("add", "DOMAttrModified", function(e) {
                    o()
                }),
                s("add", "DOMNodeInserted", l.bind(e))) : (g.observer = new t(function(e) {
                    o()
                }
                ),
                ...
                g.status = "progress",
                "interactive" !== document.readyState && "complete" !== document.readyState || !document.body ? s("add", "DOMContentLoaded", this.loaded.bind(this)) : this.loaded.bind(this)()
            }
        }
    };
    window.Rimg = Object.create(e()),
...
function(f) {
    ...
    var v = window.MutationObserver || window.WebKitMutationObserver || !1
      ...
      , Q = function() {
        ...
        a: {
            for (h = ["-webkit-grab", "-moz-grab", "grab"],
            (d.ischrome && !d.ischrome22 || d.isie) && (h = []),
            m = 0; m < h.length; m++)
                if (n = h[m],
                c.cursor = n,
                c.cursor == n) {
      ...
      , R = function(k, c) {
        ...
        function n(b, g, q, c) {
            a._bind(b, g, function(a) {
                ...
                return "mousewheel" == g ? (c.deltaY = -.025 * a.wheelDelta,
        ...
        function p(b, g, c) {
            var d, e;
            if (0 == b.deltaMode ? (d = -Math.floor(a.opt.mousescrollstep / 54 * b.deltaX),
        ...
        this.getOffset = function() {
            ...
            return b = a.win.offset(),
            a.viewport ? (g = a.viewport.offset(),
            {
                top: b.top - g.top,
                left: b.left - g.left
            }) : b
        ...
        this.updateScrollBar = function(b) {
            if (a.ishwscroll)
                ...
                a.railh && !a.railslocked && (c = g.top,
                e = g.left,
                (f = a.opt.railhoffset) && (f.top && (c += f.top),
                f.left && (e += f.left)),
        ...
        this.init = function() {
            if (a.saved.css = [],
            e.isie7mobile || e.isoperamini)
                return !0;
            if (e.hasmstouch && a.css(a.ispage ? f("html") : a.win, {
            ...
            !a.ispage || !e.cantouch && !e.isieold && !e.isie9mobile) {
                var b = a.docscroll;
                ...
                var d, h, J, k = ["left", "right", "top", "bottom"];
                for (J in k)
                    h = k[J],
                ...
                e.cantouch && a.opt.gesturezoom && (a.ongesturezoom = function(b) {
                    return 1.5 < b.scale && a.doZoomIn(b),
                ...
                a.railh = !1;
                var l;
                if (a.opt.horizrailenabled && (a.css(b, {
                    "overflow-x": "hidden"
                }),
                ...
                e.isie9mobile)
                    ...
                    a.onmangotouch = function() {
                        ...
                        if (0 != Math.round(Math.sqrt(Math.pow(e, 2) + Math.pow(g, 2)))) {
                            ...
                            a.mangotouch.ly = b,
                            a.mangotouch.lx = c,
                            g > 2 && (a.mangotouch.lazy = setTimeout(function() {
                                a.mangotouch.lazy = !1,
                                a.mangotouch.dry = 0,
                                a.mangotouch.drx = 0,
                                a.mangotouch.tm = 0,
                    ...
                    if (e.cantouch || a.istouchcapable || a.opt.touchbehavior || e.hasmstouch) {
                        ...
                        a.ontouchstart = function(b) {
                            ...
                            !a.railslocked) {
                                ...
                                if (a.cancelScroll(),
                                (c = a.getTarget(b)) && /INPUT/i.test(c.nodeName) && /range/i.test(c.type))
                                ...
                                a.ispage || !a.opt.directionlockdeadzone)
                                    a.rail.drag.dl = "f";
                                else {
                                    var g = f(window).width()
                                      ...
                                      , d = Math.max(0, h - d)
                                      , g = Math.max(0, q - g);
                                    a.rail.drag.ck = !a.rail.scrollable && a.railh.scrollable ? d > 0 ? "v" : !1 : a.rail.scrollable && !a.railh.scrollable && g > 0 ? "h" : !1,
                                    a.rail.drag.ck || (a.rail.drag.dl = "f")
                                }
                                if (a.opt.touchbehavior && a.isiframe && e.isie && (g = a.win.position(),
                                a.rail.drag.x += g.left,
                                a.rail.drag.y += g.top),
                                a.hasmoving = !1,
                                a.lastmouseup = !1,
                                a.scrollmom.reset(b.clientX, b.clientY),
                                !e.cantouch && !this.istouchcapable && !b.pointerType) {
                                    if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                                        ...
                                        c.onclick = function(b) {
                                            return a.hasmoving ? !1 : void c._onclick.call(this, b)
                                        }
                                        ),
                        ...
                        a.ontouchmove = function(b, c) {
                            ...
                            if (2 == a.rail.drag.pt) {
                                ...
                                q = 0));
                                var l;
                                if (a.railh && a.railh.scrollable && (l = a.isrtlmode ? u - a.rail.drag.sl : a.rail.drag.sl - u,
                    ...
                    if (a.onmousedown = function(b, c) {
                        if (!a.rail.drag || 1 == a.rail.drag.pt) {
                            ...
                            var g = a.getTarget(b);
                            return !a.ispage && e.hasmousecapture && g.setCapture(),
                    ...
                    a.onmouseup = function(b) {
                        return a.rail.drag ? 1 != a.rail.drag.pt ? !0 : (e.hasmousecapture && document.releaseCapture(),
                        a.isiframe && !e.hasmousecapture && a.doc.css("pointer-events", a.saved.csspointerevents),
                        a.rail.drag = !1,
                        a.hasmoving && a.triggerScrollEnd(),
                        a.cancelEvent(b)) : void 0
                    }
                    ,
                    ...
                    e.cantouch || a.opt.touchbehavior)
                        a.onpreventclick = function(b) {
                            return a.preventclick ? (a.preventclick.tg.onclick = a.preventclick.click,
                            a.preventclick = !1,
                            a.cancelEvent(b)) : void 0
                        }
                        ,
                    ...
                    (a.opt.cursordragontouch || !e.cantouch && !a.opt.touchbehavior) && (a.rail.css({
                        cursor: "default"
                    }),
                    a.railh && a.railh.css({
                        cursor: "default"
                    ...
                    a.jqbind(a.rail, "mouseenter", function() {
                        return a.ispage || a.win.is(":visible") ? (a.canshowonmouseevent && a.showCursor(),
                        void (a.rail.active = !0)) : !1
                    }),
                ...
                e.ischrome && !a.ispage && !a.haswrapper) {
                ...
                !1 !== v && (a.observerbody = new v(function(b) {
                    return b.forEach(function(b) {
                        return "attributes" == b.type ? f("body").hasClass("modal-open") ? a.hide() : a.show() : void 0
                    }),
                    document.body.scrollHeight != a.page.maxh ? a.lazyResize(30) : void 0
                }
                ),
            ...
            if ("IFRAME" == this.doc[0].nodeName) {
                var M = function() {
                    ...
                    !e.isios && a.opt.iframeautoresize && !a.isiframe) {
                        a.win.scrollTop(0),
                        a.doc.height("");
                    ...
                    (e.cantouch || a.opt.touchbehavior) && (a.bind(b, "mousedown", a.ontouchstart),
        ...
        this.showCursor = function(b, c) {
            ...
            a.cursortimeout = 0),
            a.rail) {
                if (a.autohidedom && (a.autohidedom.stop().css({
                    opacity: a.opt.cursoropacitymax
                }),
                a.cursoractive = !0),
        ...
        this.onResize = function(b, c) {
            ...
            a.page.maxh == d && a.page.maxw == e && a.view.w == h && a.view.h == f) {
                if (a.ispage)
                    return a;
                if (d = a.win.offset(),
                a.lastposition && (e = a.lastposition,
                e.top == d.top && e.left == d.left))
                    return a;
                a.lastposition = d
            }
            return 0 == a.page.maxh ? (a.hideRail(),
            a.scrollvaluemax = 0,
            a.scroll.y = 0,
            a.scrollratio.y = 0,
            a.cursorheight = 0,
            ...
            a.railslocked ? (a.ispage || a.updateScrollBar(a.view),
            !1) : (a.hidden || a.visibility ? a.hidden || a.railh.visibility || a.showRailHr() : a.showRail().showRailHr(),
        ...
        this.showRail = function() {
            return 0 == a.page.maxh || !a.ispage && "none" == a.win.css("display") || (a.visibility = !0,
            a.rail.visibility = !0,
        ...
        this.showRailHr = function() {
            return a.railh ? (0 == a.page.maxw || !a.ispage && "none" == a.win.css("display") || (a.railh.visibility = !0,
        ...
        this.hideRailHr = function() {
            return a.railh ? (a.railh.visibility = !1,
        ...
        this.scrollstart = function(b) {
            return this.onscrollstart = b,
            a
        }
        ,
        this.scrollend = function(b) {
            return this.onscrollend = b,
            a
        }
        ,
        this.scrollcancel = function(b) {
            return this.onscrollcancel = b,
            a
        }
        ,
        this.zoomin = function(b) {
            return this.onzoomin = b,
            a
        }
        ,
        this.zoomout = function(b) {
            return this.onzoomout = b,
            a
        }
        ,
        this.isScrollable = function(a) {
            if (a = a.target ? a.target : a,
            "OPTION" == a.nodeName)
                return !0;
        ...
        this.onmousewheel = function(b) {
            if (!a.wheelprevented) {
                ...
                if (a.rail.drag)
                    return a.cancelEvent(b);
                if ("auto" == a.opt.oneaxismousemode && 0 != b.deltaX && (a.opt.oneaxismousemode = !1),
                a.opt.oneaxismousemode && 0 == b.deltaX && !a.rail.scrollable)
                    return a.railh && a.railh.scrollable ? a.onmousewheelhr(b) : !0;
                var c = +new Date
                  , d = !1;
                return a.opt.preservenativescrolling && a.checkarea + 600 < c && (a.nativescrollingarea = a.isScrollable(b),
                d = !0),
                a.checkarea = c,
                a.nativescrollingarea ? !0 : ((b = p(b, !1, d)) && (a.checkarea = 0),
                b)
            }
        }
        ,
        this.onmousewheelhr = function(b) {
            if (!a.wheelprevented) {
                ...
                d = !0),
                a.checkarea = c,
                a.nativescrollingarea ? !0 : a.railslocked ? a.cancelEvent(b) : p(b, !0, d)
            }
        }
        ,
        this.stop = function() {
            return a.cancelScroll(),
        ...
        this.getTransitionSpeed = function(b) {
            ...
            return b = Math.min(c, Math.round(b / 20 * a.opt.scrollspeed)),
            b > 20 ? b : 0
        }
        ,
        a.opt.smoothscroll ? a.ishwscroll && e.hastransition && a.opt.usetransition && a.opt.smoothscroll ? (this.prepareTransition = function(b, c) {
            var d = c ? b > 20 ? b : 0 : a.getTransitionSpeed(b)
              , f = d ? e.prefixstyle + "transform " + d + "ms ease-out" : "";
            return a.lasttransitionstyle && a.lasttransitionstyle == f || (a.lasttransitionstyle = f,
        ...
        this.doScrollPos = function(b, c, d) {
            var f = a.getScrollTop()
              , h = a.getScrollLeft();
            return (0 > (a.newscrolly - f) * (c - f) || 0 > (a.newscrollx - h) * (b - h)) && a.cancelScroll(),
            0 == a.opt.bouncescroll && (0 > c ? c = 0 : c > a.page.maxh && (c = a.page.maxh),
            0 > b ? b = 0 : b > a.page.maxw && (b = a.page.maxw)),
            a.scrollrunning && b == a.newscrollx && c == a.newscrolly ? !1 : (a.newscrolly = c,
            a.newscrollx = b,
            a.newscrollspeed = d || !1,
            a.timer ? !1 : void (a.timer = setTimeout(function() {
                var h, k, d = a.getScrollTop(), f = a.getScrollLeft();
                h = b - f,
                k = c - d,
                ...
                h > 0 && (!a.scrollrunning && a.onscrollstart && a.onscrollstart.call(a, {
                    type: "scrollstart",
                    current: {
                        x: f,
                        y: d
                ...
                a.synched("doScroll-set", function() {
                    ...
                    a.scrollendtrapped || a.onScrollTransitionEnd()
                })
            }, 50)))
        }
        ,
        ...
        this.onScrollTransitionEnd = function() {
            ...
            var b = a.getScrollTop()
              , c = a.getScrollLeft();
            return a.setScrollTop(b),
            a.railh && a.setScrollLeft(c),
            a.noticeCursor(!1, b, c),
            a.cursorfreezed = !1,
            0 > b ? b = 0 : b > a.page.maxh && (b = a.page.maxh),
            0 > c ? c = 0 : c > a.page.maxw && (c = a.page.maxw),
            b != a.newscrolly || c != a.newscrollx ? a.doScrollPos(c, b, a.opt.snapbackspeed) : (a.onscrollend && a.scrollrunning && a.triggerScrollEnd(),
            void (a.scrollrunning = !1))
        }
        ) : (this.doScrollLeft = function(b, c) {
            var d = a.scrollrunning ? a.newscrolly : a.getScrollTop();
            a.doScrollPos(b, d, c)
        ...
        this.doScrollPos = function(b, c, d) {
            function e() {
                if (a.cancelAnimationFrame)
                    return !0;
                if (a.scrollrunning = !0,
                n = 1 - n)
                    return a.timer = s(e) || 1;
                var c, d, b = 0, g = d = a.getScrollTop();
                a.dst.ay ? (g = a.bzscroll ? a.dst.py + a.bzscroll.getNow() * a.dst.ay : a.newscrolly,
                c = g - d,
                (0 > c && g < a.newscrolly || c > 0 && g > a.newscrolly) && (g = a.newscrolly),
                a.setScrollTop(g),
                g == a.newscrolly && (b = 1)) : b = 1,
                d = c = a.getScrollLeft(),
                a.dst.ax ? (d = a.bzscroll ? a.dst.px + a.bzscroll.getNow() * a.dst.ax : a.newscrollx,
                c = d - c,
                (0 > c && d < a.newscrollx || c > 0 && d > a.newscrollx) && (d = a.newscrollx),
                a.setScrollLeft(d),
                d == a.newscrollx && (b += 1)) : b += 1,
                2 == b ? (a.timer = 0,
                a.cursorfreezed = !1,
                a.bzscroll = !1,
                a.scrollrunning = !1,
            ...
            if (c = "undefined" == typeof c || !1 === c ? a.getScrollTop(!0) : c,
            a.timer && a.newscrolly == c && a.newscrollx == b)
                return !0;
            a.timer && t(a.timer),
            a.timer = 0;
            var f = a.getScrollTop()
            ...
            d && 1 >= d && (k *= d),
            a.bzscroll = k > 0 ? a.bzscroll ? a.bzscroll.update(m, k) : new A(l,m,k,0,1,0,1) : !1,
            !a.timer) {
        ...
        this.doScrollBy = function(b, c) {
            ...
            if (a.bouncescroll) {
                ...
                -e > d ? d = -e : d > a.page.maxh + e && (d = a.page.maxh + e)
            }
            return a.cursorfreezed = !1,
            e = a.getScrollTop(!0),
            0 > d && 0 >= e ? a.noticeCursor() : d > a.page.maxh && e >= a.page.maxh ? (a.checkContentSize(),
            a.noticeCursor()) : void a.doScrollTop(d)
        }
        ,
        this.doScrollLeftBy = function(b, c) {
            ...
            if (a.bouncescroll) {
                ...
                -e > d ? d = -e : d > a.page.maxw + e && (d = a.page.maxw + e)
            }
            return a.cursorfreezed = !1,
            e = a.getScrollLeft(!0),
            0 > d && 0 >= e || d > a.page.maxw && e >= a.page.maxw ? a.noticeCursor() : void a.doScrollLeft(d)
        }
        ,
        ...
        this.doZoomIn = function(b) {
            if (!a.zoomactive) {
                ...
                var h, c = "position top left zIndex backgroundColor marginTop marginBottom marginLeft marginRight".split(" "), d = a.win[0].style;
                for (h in c) {
                    var k = c[h];
                    a.zoomrestore.style[k] = "undefined" != typeof d[k] ? d[k] : ""
                }
                return a.zoomrestore.style.width = a.win.css("width"),
        ...
        this.doZoomOut = function(b) {
            return a.zoomactive ? (a.zoomactive = !1,
            a.win.css("margin", ""),
      ...
      , L = function(f) {
        ...
        this.doMomentum = function(f) {
            ...
            var n = c.nc.getScrollTop()
              , p = c.nc.page.maxh
              , a = c.nc.page.maxw;
            if (c.speedx = a > 0 ? Math.min(60, c.speedx) : 0,
            c.speedy = p > 0 ? Math.min(60, c.speedy) : 0,
            d = d && 60 >= k - d,
            (0 > n || n > p || 0 > f || f > a) && (d = !1),
            f = c.speedx && d ? c.speedx : !1,
            c.speedy && d && c.speedy || f) {
    ...
    f.cssHooks.pageYOffset = {
        ...
        set: function(k, c) {
            ...
            return h && h.ishwscroll ? h.setScrollTop(parseInt(c)) : w.call(k, c),
            this
        }
    },
    ...
    f.cssHooks.pageXOffset = {
        ...
        set: function(k, c) {
            var h = f.data(k, "__nicescroll") || !1;
            return h && h.ishwscroll ? h.setScrollLeft(parseInt(c)) : B.call(k, c),
            this
        }
    },
    ...
    f.fn.niceScroll = function(k, c) {
        ...
        c.win = f(this));
        var m = !("doc"in c);
        return m || "win"in c || (c.win = f(this)),
        this.each(function() {
...
function(f, g, k) {
    var l = {
        ...
        watchVisibility: function() {
            ...
            void (a.checkVisible = g.setInterval(function() {
        ...
        updateItems: function() {
            ...
            if (a = f(this.options.responsiveBaseWidth).width(),
        ...
        response: function() {
            var b, e, a = this;
            return !0 !== a.options.responsive ? !1 : (e = f(g).width(),
            a.resizer = function() {
        ...
        appendItemsSizes: function() {
            ...
            a.$owlItems.each(function(c) {
                ...
                (0 === c % a.options.items || c === e) && (c > e || (b += 1)),
        ...
        goTo: function(a, b, e) {
            var c = this;
            return c.isTransition ? !1 : ("function" == typeof c.options.beforeMove && c.options.beforeMove.apply(this, [c.$elem]),
        ...
        play: function() {
            ...
            !1 === a.options.autoPlay ? !1 : (g.clearInterval(a.autoPlayInterval),
        ...
        removeItem: function(a) {
            return 0 === this.$elem.children().length ? !1 : (a = void 0 === a || -1 === a ? -1 : a,
            this.unWrap(),
