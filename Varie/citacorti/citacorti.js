$(document).ready(function() { //alla creazione del DOM chiamo subito generate()
    ...
    $(".lista").on("click", function() { //al click sul bottone richiama generate
        $('.elenco_completo').slideToggle();
        $('html, body').animate({
            scrollTop: $(".elenco_completo").offset().top
        }, 1000);
    });
});
